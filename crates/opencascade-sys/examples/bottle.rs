use cxx::UniquePtr;
use opencascade_sys::{
    export::{write_stl, StlAPIWriter_ctor},
    ffi::{
        cylinder_to_surface, dynamic_type, ellipse_to_HandleGeom2dCurve, ellipse_value, gp_DZ,
        gp_OX, handle_geom_plane_location, new_HandleGeomCurve_from_HandleGeomTrimmedCurve,
        new_HandleGeomPlane_from_HandleGeomSurface, new_list_of_shape, new_point, new_point_2d,
        new_transform, new_vec, shape_list_append_face, type_name, BRepAlgoAPIFuse_ctor,
        ...
        BRepBuilderAPI_MakeWire_edge_edge_edge, BRepBuilder_ctor,
        BRepBuilder_upcast_to_topodsbuilder, BRepFilletAPIMakeFillet_ctor, BRepLibBuildCurves3d,
        BRepMeshIncrementalMesh_ctor, BRepOffsetAPIMakeThickSolid_ctor,
        BRepOffsetAPIThruSections_ctor, BRepPrimAPIMakeCylinder_ctor, BRepPrimAPIMakePrism_ctor,
        BRep_Tool_Surface, ExplorerCurrentShape, GCE2dMakeSegment_point_point,
        GCMakeArcOfCircle_Value, GCMakeArcOfCircle_point_point_point, GCMakeSegment_Value,
        GCMakeSegment_point_point, Geom2dEllipse_ctor, Geom2dTrimmedCurve_ctor,
        GeomCylindricalSurface_ctor, GpAx2_ctor, GpAx2d_ctor, GpAx3_from_GpAx2, GpDir2d_ctor,
        HandleGeom2dTrimmedCurve_to_curve, MakeThickSolidByJoin, TopAbsShapeEnum,
